...
select
        ...
        r.executed_at                                               as executed_at_time,
        cast(r.executed_at as date)                                 as executed_at_date,

        r.note                                                      as note,

        r.start_time                                                as start__time,
        cast(r.start_time as date)                                  as start__date,

        r.ticket_id                                                 as ticket_id,
        r.time_spent                                                as time_spent,
        r.timer_running                                             as timer_running,
